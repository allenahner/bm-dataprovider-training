...
class ExampleSqlServerDataCollector : ISelfDescribingDataCollector {
    override fun getCollectorType(): String { return ExampleSqlServerDataCollectorProperties.DATA_COLLECTOR_TYPE }

    override fun getCollectorDescription(): String { return ExampleSqlServerDataCollectorProperties.DATA_COLLECTOR_DESCRIPTION }

    override fun getCollectorLabel(): String { return ExampleSqlServerDataCollectorProperties.DATA_COLLECTOR_LABEL }

    override fun getCollectorVersion(): String { return ExampleSqlServerDataCollectorProperties.DATA_COLLECTOR_VERSION }

    override fun describeTestConnectionResult(): ITestConnectionResultDefinition { throw NotImplementedError() }

    override fun describeCollectionResult(): ICollectionResultDefinition { throw NotImplementedError() }
